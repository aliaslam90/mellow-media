...
const Promise = () => {
  ...
  <section style={{
    ...
    {/* Rolling wave bands — same motion as the hero, light overlay tint */}
    <svg
      viewBox="0 0 1440 800"
      preserveAspectRatio="xMidYMid slice"
      style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', opacity: 0.3, pointerEvents: 'none', mixBlendMode: 'screen' }}
      aria-hidden="true"
    >
      <defs>
        <linearGradient id="promBand1" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#FBC2A4" />
          <stop offset="100%" stopColor="#F78762" />
        </linearGradient>
        <linearGradient id="promBand2" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#FBDCE3" />
          <stop offset="100%" stopColor="#EA829A" />
        </linearGradient>
        <linearGradient id="promBand3" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#FFE7C2" />
          <stop offset="100%" stopColor="#E9BE6A" />
        </linearGradient>
      </defs>
      ...
      <path
        d="M -50 200 C 240 130, 540 270, 820 200 S 1280 130, 1500 210 L 1500 290 C 1280 360, 820 240, 540 320 S 240 250, -50 290 Z"
        fill="url(#promBand1)" opacity="0.55"
      >
        {!reducedMotion && (
          <animate
            attributeName="d"
      ...
      <path
        d="M -50 420 C 260 360, 560 480, 860 410 S 1280 350, 1500 430 L 1500 510 C 1280 580, 860 470, 560 540 S 260 480, -50 510 Z"
        fill="url(#promBand2)" opacity="0.5"
      >
        {!reducedMotion && (
          <animate
            attributeName="d"
      ...
      <path
        d="M -50 640 C 260 580, 560 700, 860 630 S 1280 570, 1500 650 L 1500 800 L -50 800 Z"
        fill="url(#promBand3)" opacity="0.55"
      >
        {!reducedMotion && (
          <animate
            attributeName="d"
